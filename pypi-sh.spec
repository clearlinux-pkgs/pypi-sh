...
Source0  : https://files.pythonhosted.org/packages/59/52/f43920223c93e31874677c681b8603d36a40d3d8502d3a37f80d3995d43e/sh-2.2.2.tar.gz
...
%prep
%setup -q -n sh-2.2.2
cd %{_builddir}/sh-2.2.2
pushd ..
cp -a sh-2.2.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740409736
