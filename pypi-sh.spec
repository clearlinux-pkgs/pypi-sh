...
Source0  : https://files.pythonhosted.org/packages/bd/30/abf254f7b56ba7bcae938767e3ee0f54d220d931a35a8721de350b76dec5/sh-2.2.1.tar.gz
...
%prep
%setup -q -n sh-2.2.1
cd %{_builddir}/sh-2.2.1
pushd ..
cp -a sh-2.2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736522873
