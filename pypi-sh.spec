...
Source0  : https://files.pythonhosted.org/packages/52/12/b7965006c5adc57ba5459385358bd27c4983cd490884a75be86eb1d3efeb/sh-2.1.0.tar.gz
...
%prep
%setup -q -n sh-2.1.0
cd %{_builddir}/sh-2.1.0
pushd ..
cp -a sh-2.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728484377
