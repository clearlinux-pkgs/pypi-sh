...
Source0  : https://files.pythonhosted.org/packages/14/7a/5148402146d360a6d15922814a3b065b52be3a5fe878a8834d3ce4e7d33f/sh-2.0.7.tar.gz
...
%prep
%setup -q -n sh-2.0.7
cd %{_builddir}/sh-2.0.7
pushd ..
cp -a sh-2.0.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717433380
